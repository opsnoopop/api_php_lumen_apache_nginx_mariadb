# Nginx PHP-Apache Lumen API with MariaDB

A simple Nginx PHP-Apache Lumen API application and MariaDB, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_php_lumen_apache_nginx_mariadb.git
```

### 2. Navigate to Project Directory
```bash
cd api_php_lumen_apache_nginx_mariadb
```
